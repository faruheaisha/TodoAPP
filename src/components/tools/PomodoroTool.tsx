...
import { Play, Pause, RotateCcw, Coffee, BrainCircuit, Moon, Link2, Lock, Clock, Search, ChevronDown, Check } from 'lucide-react';
import {
  useFocusStore,
  type FocusMode,
  focusDurationFor,
...
/**
 * TodoCombobox — 可搜索的任务关联选择器（P3：任务多时原生 select 无法过滤）
 * 关闭时是与原 select 等宽的按钮；展开后顶部搜索框 + 过滤列表（160px 内滚动）。
 */
function TodoCombobox({
