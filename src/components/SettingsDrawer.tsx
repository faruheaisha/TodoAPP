        ...
        <>
          ...
          >
            ...
            <div className="px-5 py-4 space-y-5">
              ...
              <SettingItem icon={<Globe size={14} />} label={t('settings.language')}>
                <div className="flex gap-1">
                  <button
                    ...
                    style={{
                      backgroundColor: language === 'zh' ? 'var(--color-accent)' : 'transparent',
                      color: language === 'zh' ? '#FAF9F7' : 'var(--color-text-secondary)',
                      borderColor: 'var(--color-border)',
                    }}
                  >
                    中文
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-md text-xs font-medium transition-all border`}
                    style={{
                      backgroundColor: language === 'en' ? 'var(--color-accent)' : 'transparent',
                      color: language === 'en' ? '#FAF9F7' : 'var(--color-text-secondary)',
                      borderColor: 'var(--color-border)',
                    }}
                  >
                    English
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    style={{
                      ...
                      color: theme === 'light' ? '#FAF9F7' : 'var(--color-text-secondary)',
                      borderColor: 'var(--color-border)',
                    }}
                  >
                    <Sun size={12} />
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: theme === 'dark' ? '#FAF9F7' : 'var(--color-text-secondary)',
                      borderColor: 'var(--color-border)',
                    }}
                  >
                    <Moon size={12} />
              ...
              {/* Startup Delay */}
              <SettingItem
                label={`${t('settings.startupDelay')}: ${startupDelay} ${t('settings.minutes')}`}
              >
                <input
                  type="range"
                  min="1"
              ...
              <div className="border-t pt-4" style={{ borderColor: 'var(--color-border)' }}>
                ...
                <div className="space-y-2">
                  <ExportButton
                    ...
                    onClick={() => exportTodosJSON(todos, `todoapp-${today}.json`)}
                  />
                  <ExportButton
                    icon={<FileSpreadsheet size={13} />}
                    label={t('settings.exportCSV')}
                    onClick={() => exportTodosCSV(todos, `todoapp-${today}.csv`)}
                  />
                  <ExportButton
                    icon={<FileText size={13} />}
                    label={t('settings.exportPDF')}
                    onClick={() => {
                      // PDF export — placeholder, implemented later
              ...
              <div className="border-t pt-4" style={{ borderColor: 'var(--color-border)' }}>
                <div className="space-y-2">
                  <ExportButton
                    ...
                    onClick={() => exportTodosJSON(todos, `todoapp-backup-${today}.json`)}
                  />
                  <ExportButton
                    icon={<Upload size={13} />}
